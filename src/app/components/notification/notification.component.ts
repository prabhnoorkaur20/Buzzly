...
//   showNoNotificationsMessage: boolean = false;
...
//   // clearNotifications(): void {
//   //   this.notifications = [];
//   //   this.showNoNotificationsMessage = true;
//   // }
...
//       notification.read = true;
//     }
//     this.checkNotifications(); // Call checkNotifications after marking as read
//   }

//   clearNotifications(): void {
//     this.notifications = [];
//     this.showNoNotificationsMessage = true;
//     this.checkNotifications(); // Call checkNotifications after clearing
//   }

//   resetNotifications(newNotifications: OpenProjectNotification[]): void {
//     this.notifications = newNotifications;
//     this.showNoNotificationsMessage = false;
//     this.checkNotifications();
//   }

//   checkNotifications(): void {
//     if (this.notifications.length > 0) {
//       this.showNoNotificationsMessage = false; // Reset the message flag
//     }
//   }
// }
import { Component, OnInit } from '@angular/core';
